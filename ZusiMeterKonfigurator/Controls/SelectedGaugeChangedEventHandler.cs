...
// Type: ZusiMeterKonfigurator.Controls.SelectedGaugeChangedEventHandler
...
{
  public delegate void SelectedGaugeChangedEventHandler(
    object sender,
    SelectedGaugeChangedEventArgs e);
}
