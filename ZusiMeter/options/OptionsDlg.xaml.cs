...
namespace ZusiMeter.Options
{
  ...
  public partial class OptionsDlg : Window, IComponentConnector
  {
    ...
    public OptionsDlg(MainWindow mainWindow)
    {
      ...
      this.CommandBindings.Add(new CommandBinding((ICommand)OptionsDlg.CommandDefinePrivateLayoutFolder, new ExecutedRoutedEventHandler(mainWindow.OnDefinePrivateLayoutFolder)));
      this.CommandBindings.Add(new CommandBinding((ICommand)OptionsDlg.CommandDefineExampleLayoutFolder, new ExecutedRoutedEventHandler(mainWindow.OnDefineExampleLayoutFolder)));
